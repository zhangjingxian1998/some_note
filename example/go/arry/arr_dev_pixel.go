...
func Arr_dev_pixel(arr1 interface{}, arr2 interface{}) interface{} {
	...
	case []int:
		...
		case []int:
			...
			return Arr_dev_pixel_int(arr1, arr2)
		case []float32:
			arr1 := Interface2Int(arr1)
			arr1_float_32 := Int2Float32(arr1)
			arr2 := Interface2Float32(arr2)
			return Arr_dev_pixel_float32(arr1_float_32, arr2)
		case []float64:
			arr1 := Interface2Int(arr1)
			arr1_float_32 := Int2Float64(arr1)
			arr2 := Interface2Float64(arr2)
			return Arr_dev_pixel_float64(arr1_float_32, arr2)
		case int:
			arr1 := Interface2Int(arr1)
			...
			return Arr_dev_pixel_int(arr1, arr_tmp)
		case float32:
			arr1 := Interface2Int(arr1)
			arr1_float_32 := Int2Float32(arr1)
			...
			return Arr_dev_pixel_float32(arr1_float_32, arr_tmp)
		case float64:
			arr1 := Interface2Int(arr1)
			...
			return Arr_dev_pixel_float64(arr1_float_64, arr_tmp)
		}
	case []float32:
		switch arr2.(type) {
		case []int:
			...
			return Arr_dev_pixel_float32(arr1, arr2_float_32)
		case []float32:
			arr1 := Interface2Float32(arr1)
			arr2 := Interface2Float32(arr2)
			return Arr_dev_pixel_float32(arr1, arr2)
		case []float64:
			arr1 := Interface2Float32(arr1)
			arr1_float_64 := Float322Float64(arr1)
			arr2 := Interface2Float64(arr2)
			return Arr_dev_pixel_float64(arr1_float_64, arr2)
		case int:
			arr1 := Interface2Float32(arr1)
			arr_tmp := make([]float32, value1.Len())
			for i := 0; i < value1.Len(); i++ {
			...
			return Arr_dev_pixel_float32(arr1, arr_tmp)
		case float32:
			arr1 := Interface2Float32(arr1)
			arr_tmp := make([]float32, value1.Len())
			for i := 0; i < value1.Len(); i++ {
		...
		case float64:
			...
			return Arr_dev_pixel_float64(arr1, arr_tmp)
		}
	case []float64:
		switch arr2.(type) {
		case []int:
			...
			return Arr_dev_pixel_float64(arr1, arr2_float_64)
		case []float32:
			arr1 := Interface2Float64(arr1)
			arr2 := Interface2Float32(arr2)
		...
		case []float64:
			arr1 := Interface2Float64(arr1)
			arr2 := Interface2Float64(arr2)
			return Arr_dev_pixel_float64(arr1, arr2)
		case int:
			arr1 := Interface2Float64(arr1)
			arr_tmp := make([]float64, value1.Len())
			for i := 0; i < value1.Len(); i++ {
...
func Arr_dev_pixel_float32(arr1 []float32, arr2 []float32) []float32 {
...
func Arr_dev_pixel_float64(arr1 []float64, arr2 []float64) []float64 {
